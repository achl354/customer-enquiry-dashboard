...
- PARTS_ENQUIRY: a customer or supplier asking about a specific spare part — part code, price, or stock count for a replacement/wear item (e.g. a hose, buckle, brake wire), not a fault report. If the part is needed because something broke, prefer EQUIPMENT_FAULT; if the message is really about a price list/quote, prefer QUOTE_PRICING. This is for the narrower "what's the part number and do you have it in stock" case.
