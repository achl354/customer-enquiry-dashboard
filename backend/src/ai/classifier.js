...
- PRODUCT_ENQUIRY: general customer product/compatibility/hire questions, sales leads, or website contact-form enquiries. Website enquiries carry a city tag in the subject like "[SYDNEY] Enquiry from JD Healthcare Group Website" or a "New sales lead for: <product>" subject — these are ALWAYS forwarded to a territory rep, never answered directly, regardless of what the body says (even if it mentions pricing). City routing: SYDNEY->Simon White, MELBOURNE->Atul Gupta/Allan Baker, ADELAIDE->Miffy Boden, PERTH->Edan Hanley/Rhys Hosgood, NEWCASTLE->Minh-Thu Cao Xuan, AUCKLAND->Medix21 (external distributor). Simple factual questions (e.g. cleaning instructions) can be answered directly from a spec sheet.
